...
function initvars() {
    chrome.storage.local.get(['popup_numbers', 'popup_message', 'popup_send_attachments', 'popup_attachment_type', 'time_gap', 'time_gap_checked', 'time_gap_type', 'batch_checked', 'batch_size', 'batch_gap', 'file_name', 'csv_data', 'customization', 'schedule_time', 'my_number'], function (result) {
        ...
        trackEvent('my_number_popup', my_number);
    });
}
        ...
        if(result.no_of_visit === undefined){
            ...
            chrome.tabs.query({active: true, lastFocusedWindow: true}, function (tabs) {
                ...
                if (url !== "https://web.whatsapp.com" && url !== "https://web.whatsapp.com/")
                    ...
                    if((result.no_of_visit > 10) && (result.rate_us === undefined)) {
                        document.getElementById("rate_us").style.display = 'block';
